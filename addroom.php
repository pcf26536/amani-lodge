...
if (e==null || e=="")
  ...
  return false;
    ...
    let f=document.forms["addroom"]["max_adult"].value;
    if (f==null || f==="")
    {
        alert("Pls. enter max number of adults");
        return false;
    }
    let g=document.forms["addroom"]["max_child"].value;
    if (g==null || g==="")
    {
        alert("Pls. enter max number of children");
        return false;
    }
...
jQuery(function($){
   $("#rate").Watermark("rate");
   $("#qty").Watermark("Quantity");
   $("#desc").Watermark("description");
   $("#image").Watermark("room image");
   $("#type").Watermark("Room type");
...
Maximum Number of Adults<br />
    <input name="max_adult" type="number" class="ed" /><br />
Maximum Number of Children<br />
    <input name="max_child" type="number" class="ed" /><br />
