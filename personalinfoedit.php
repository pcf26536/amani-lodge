...
$result = mysqli_query("SELECT * FROM reservation where confirmation='$confirm'");
while($row = mysqli_fetch_array($result))
  {	
	...
	$no_room=$row['no_room'];
	$room_id=$row['room_id'];
	$result = mysqli_query("SELECT * FROM room WHERE room_id='$room_id'");
...
<div id="featured">
 ...
 <table width="502" border="0">
    ...
    <tr>
      ...
      <span class="style1"><small>i agree the <a rel="facebox" href="terms_condition.php">terms and condition</a> of Mara Lodge</small></span></label></td>
      </tr>
    <tr>
      <td><div align="right"></div></td>
      <td><div id="Layer1">
...
<p>Copyright &copy; MARA LODGE. Designed by <a href="#" target="_blank">SHEILA</a></p>
</div>
