...
<!--sa poip up-->
 <link href="src/facebox.css" media="screen" rel="stylesheet" type="text/css" />
  ...
  <style type="text/css">
<!--
.style6 {color: #808000; font-weight: bold; }
.style7 {color: #808000}
-->
  </style>
</head>
...
<div style="margin-top:20px; margin-left:10px;">
 <table width="186" border="0">
  ...
  <tr>
    <td colspan="2"><div align="right"><a href="cancelindex.php">Cancel</a> Reservation </div></td>
    </tr>
</table> 
 </div>    
</form>
...
<div id="featured"><br />
 <div><strong><h3 align="center"><u>TERMS AND CONDITIONS</u></h3></strong></div>
 <br />
  
		<br /><br />
		 <p class="style6">1.Theft and loss of Hotel's items by the customer is subject to fine and prosecution</p>
		 </br>
		<p class="style6"> 2.Management is not responsible for Luggages lost or damaged and customers are advised to take care of their goods.</p>
		</br>
		<p class="style6"> 3.Noise and unnecessary commotions within the premise are prohibited.</p>
		</br>
		<p class="style6"> 4.Retain receipt until completion of your stay.</p></br>
		<p class="style6"> 5.Food and drinks from outside the hotel are not allowed</p></br>
		<p class="style6">6. Any form of drug abuse is not allowed.<strong>This is a free drug zone</ strong></p>
		</br> 
		 <P class="style6">7.No refund once you quit the Hotel prior to your check out date</p></br> 
		<p class="style6"> 8.Anyone booking must follow the payment instruction.</p>
		</br>
		<p class="sytle6 style7"><strong> 9.To cancel your reservation prior to checkin date,10%of total fee is charged</strong></p>
		</br> 
		<p class="style6">10. Any form of criminality is subject to prosecution and penalty</p>
		</br>
		<p class="style6"> 11.The management has power to discontinue the client before the check out date incase of irregularity for security purposes </p>
